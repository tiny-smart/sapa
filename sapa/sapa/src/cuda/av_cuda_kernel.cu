...
__global__ void AVForward(const int nthreads,
...
int AVForwardLauncher(const at::Tensor features, const at::Tensor masks,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      features.scalar_type(), "AVLauncherForward", ([&] {
...
int AVBackwardLauncher(const at::Tensor top_grad,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      top_grad.scalar_type(), "KVLauncherBackward", ([&] {
